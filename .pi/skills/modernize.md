...
2. Use the lifecycle in [references/lifecycle.md](modernize-references/lifecycle.md).
3. Use [references/source-map.md](modernize-references/source-map.md) for the canonical protocol and script sources.
...
- For workflow sequencing: [references/lifecycle.md](modernize-references/lifecycle.md)
- For source mapping and quality gates: [references/source-map.md](modernize-references/source-map.md)

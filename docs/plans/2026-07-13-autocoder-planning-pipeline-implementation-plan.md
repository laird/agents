...
Then encode the pipeline inline (steps 0–6 from spec §3):
  - Step 0: ensure `decomposed`/`subtask` labels exist (reuse the label-bootstrap block at `dev.md:459` — the `for label in …` loop; formerly `fix.md:442` pre-rename).

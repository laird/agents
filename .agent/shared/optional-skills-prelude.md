# Canonical Optional Skills Prelude (Antigravity mirror)

This file is the Antigravity mirror of `plugins/shared/optional-skills-prelude.md`.
Both files hold byte-identical sentinel-bracketed regions; only this header text
differs. Drift between them is detected by `scripts/check-optional-skills-drift.sh`.

...
| Task | Model |
|------|-------|
| Simple (P2/P3, clear fix) | claude-sonnet-5 |
| Complex/architectural (P0/P1) | claude-opus-5 |
| Root cause (unclear after initial look) | claude-opus-5 |
| Regression test analysis | claude-sonnet-5 |
| Improvement proposals | claude-opus-5 |
| Labels, comments, commit messages | claude-haiku-4-5 |

Start with claude-sonnet-5; escalate to claude-opus-5 after 2 failed attempts or when root cause spans 5+ files.
